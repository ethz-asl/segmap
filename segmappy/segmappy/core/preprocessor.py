...
class Preprocessor(object):
    ...
    def _augment_rotation_yaw(self, segments):
        ...
        for i in range(len(segments)):
            ...
            segments[i] = np.matmul(
                segments[i], self._get_rotation_matrix_z(rotation))
        ...
        for i, segment in enumerate(segments):
            ...
            while True:
                ...
                for plane_offset in plane_offsets:
                    ...
                    if remove_percentage > self.augment_remove_plane_min and remove_percentage < self.augment_remove_plane_max:
                        segments[i] = segment[keep] + center
